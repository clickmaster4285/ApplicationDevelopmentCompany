...
const Atelier = "/images/atelier.jpeg";
const Sapien = "/images/sapien.jpeg";
  ...
  return (
    <div ref={ref} className="relative min-h-screen flex items-center py-24">
      <div className="mx-auto  w-[85vw] px-6">
        <div
          className={`grid md:grid-cols-12 gap-12 items-center ${reverse ? "md:[direction:rtl]" : ""}`}
        >
          <div className="md:col-span-5 [direction:ltr]">
            <div className="text-[10px] uppercase tracking-[0.4em] text-white/40 mb-4">
              — {p.category}
            </div>
            <h3 className="text-chrome text-5xl md:text-6xl font-medium tracking-[-0.03em] leading-[1.02] text-white">
              {p.name}
            </h3>
            ...
            >
              ...
              <div className="absolute inset-0 rounded-3xl overflow-hidden">
                ...
                <div className="absolute top-0 inset-x-0 h-10 flex items-center px-4 gap-1.5 border-b border-white/10 bg-black/40 backdrop-blur-sm z-10">
                  ...
                  <span className="ml-4 text-[10px] tracking-[0.3em] text-white/50 uppercase">
                    {p.name}.app
                  </span>
                </div>
