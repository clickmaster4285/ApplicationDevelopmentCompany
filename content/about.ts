...
// Generated: 2026-07-27T11:17:31.484905
// Total about pages: 1
...
export const aboutData: AboutData = {
  ...
  pages: [
  {
    ...
    "metadata": {
      ...
      "tier": 1,
      "searchVolume": "",
      "productionNote": "EEAT and enterprise-sales critical. Every [PLACEHOLDER] must be filled with verified truth or the line deleted — a fabricated security claim is the single most damaging possible content error on this site."
    },
    "internalLinks": {},
    "related": {
      "services": [],
...
export function getAboutByUrl(url: string): PageData | undefined {
  ...
  return aboutData.pages.find(page => 
    page.url === url || 
    page.url === `/${url}` ||
...
export function getAboutByKeyword(keyword: string): PageData[] {
  return aboutData.pages.filter(page =>
