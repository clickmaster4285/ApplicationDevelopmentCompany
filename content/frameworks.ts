...
// Generated: 2026-07-27T11:17:31.477073
...
export const frameworksData: FrameworksData = {
  ...
  pages: [
  {
    ...
    "metadata": {
      ...
      "intent": "Informational/Commercial-Investigational (GEO priority — most-linked page on site, 149 internal references)",
      "funnel": "",
      "schema": [
        "Article",
        "FAQPage",
      ...
      "tier": "",
      "searchVolume": "",
      "productionNote": "Publish early — nearly every solution, cost, and platform page links here. This page is deliberately vendor-honest; that is its ranking strategy and its conversion strategy."
    },
    "internalLinks": {},
    "related": {
      "services": [],
...
export function getFrameworksByUrl(url: string): PageData | undefined {
  ...
  return frameworksData.pages.find(page => 
    page.url === url || 
    page.url === `/${url}` ||
...
export function getFrameworksByKeyword(keyword: string): PageData[] {
  return frameworksData.pages.filter(page =>
