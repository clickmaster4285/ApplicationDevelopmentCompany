...
// Generated: 2026-07-28T10:29:45.629622
...
export const solutionsData: SolutionsData = {
  totalPages: 45,
  generatedAt: "2026-07-28T10:29:45.629639",
  pages: [
    {
      ...
      structured: {
        ...
        sourceFile: "wave1-generated/solutions/accounting-software.md",
      },
    },
    {
      ...
      metadata: {
        ...
        schema: ["Service", "Product", "FAQPage", "BreadcrumbList"],
      ...
      internalLinks: [],
      related: {
        services: ["/services/ai-application-development/"],
        solutions: [],
        platforms: [],
        technologies: [],
        industries: [],
      ...
      structured: {
        faqs: [
          {
            question: "Which department should go first?",
            answer:
              "The one with the highest-volume, most pattern-shaped queue and the least catastrophic worst-case — usually support or lead-response, rarely finance-first despite the enthusiasm. The readiness call scores your candidates on volume × variation × reversibility; the ranking is usually obvious once the numbers are on the table.",
          },
          {
            question: "How do we know it won't say or do something disastrous?",
            answer:
              "Structurally, not hopefully: scoped tool access (it can't touch what it can't reach), action allow-lists, approval gates on irreversible operations, and [injection-resistant design](/resources/ai-development/ai-application-security-prompt-injection/) for everything that reads external content. Then measured accuracy before any autonomy. Safety here is [architecture](/services/ai-agent-development/), and it's inspectable.",
          },
          {
          ...
          {
            question: "How fast to first value?",
            answer:
              "Propose-mode drafting real work: weeks 3–4 of the pilot. First autonomous action types: earned by accuracy data, typically 2–3 months in. Faster offers exist; ask to see their evaluation suite.",
          },
        ],
            ...
            rows: [
              {
                ...
                "The agent": "Resolution agent with order/account tools",
                "What it absorbs":
                  "WISMO, returns, account changes, tier-1 troubleshooting — *resolving*, [not deflecting](/solutions/ai-chatbot-solutions/)",
                "Typical result profile":
                  "40–70% of tickets auto-resolved at measured accuracy; CSAT holds or rises when escalation is clean",
              },
              {
                Department: "**Sales**",
                "The agent": "Speed-to-lead + pipeline hygiene agent",
                "What it absorbs":
                  "Instant lead response, qualification, [meeting booking](/solutions/booking-system/), CRM field discipline, follow-up drafts for rep approval",
                "Typical result profile":
                  "Response time from hours to seconds — the single most reliable revenue lever in the catalog",
              },
              {
                Department: "**Operations**",
                "The agent": "Exception-handling agent",
                "What it absorbs":
                  "Order discrepancies, status chasing across systems, document collection, data reconciliation — [the BPA judgment steps](/solutions/business-process-automation/)",
                "Typical result profile":
                  "The queue nobody staffed properly, staffed",
              },
              {
                Department: "**Finance & back office**",
                "The agent": "AP/AR agent",
                "What it absorbs":
                  "Invoice matching, [document extraction](/services/generative-ai-development/), payment-status inquiries, dunning drafts — **hard gates on all money movement, permanently**",
                "Typical result profile":
                  "Days-sales-outstanding and close-cycle improvements you can audit",
              },
              {
                Department: "**Admin & scheduling**",
                "The agent": "Coordination agent",
                "What it absorbs":
                  "[Phone/SMS/web intake](/solutions/voice-ai/), scheduling against real availability, reminder handling, intake-form chasing",
                "Typical result profile":
                  "After-hours capture alone often pays the pilot",
              },
              {
                Department: "**HR & internal service**",
                "The agent": "Employee-service agent",
                "What it absorbs":
                  "Policy questions via [RAG over your handbook](/services/generative-ai-development/), onboarding checklists, ticket triage",
                "Typical result profile":
                  'The "quick question" tax on HR, refunded',
              },
              {
                Department:
                  "**Recruiting-adjacent, legal-intake, claims-intake…**",
                "The agent": "The pattern generalizes",
                "What it absorbs":
                  "Any high-volume queue of messy inputs needing judgment-then-action",
                "Typical result profile":
                  "Scored honestly in the readiness call",
              },
            ],
          },
        ],
        ...
        sourceFile: "wave0-batch8/sol14-ai-agents-for-business.md",
      },
    },
    {
      ...
      structured: {
        faqs: [
          {
            question: "Will it say something wrong to a customer?",
            answer:
              "Its error rate is a number you'll know before launch, not a fear you'll live with after. Grounding + confidence routing + eval-set measurement means the failure mode is \"let me connect you with someone\" — not confident fiction. And policy-critical topics can be hard-routed to humans regardless, at your discretion.",
          },
          {
            question: "Should it pretend to be human?",
            answer:
              "No — disclosure is both emerging law in several states and better UX: customers forgive a bot's limits and resent a fake human's. Ours introduce themselves honestly and escalate gracefully; the resolution numbers do the impressing.",
          },
          {
            question: "What about our brand voice?",
            answer:
              "Tuned and tested: tone guidelines encoded, sample conversations reviewed by your team pre-launch, and the eval set includes voice adherence — because a bot that resolves tickets in someone else's personality is still off-brand.",
          },
          {
        ...
        tables: [
          {
            headers: ["Bot", "What it does", "The line it never crosses"],
            rows: [
              {
                Bot: "**Customer support bot**",
                "What it does":
                  "Answers from your help center + policies, looks up orders/accounts, initiates simple resolutions",
                "The line it never crosses":
                  "Never invents policy; escalates with full context past its confidence line",
              },
              {
                Bot: "**Sales & pre-purchase bot**",
                "What it does":
                  "Product Q&A from your real catalog, comparison help, [handoff to booking](/solutions/booking-system/) or humans at buying signals",
                "The line it never crosses":
                  "Never fabricates specs, stock, or prices — catalog-grounded or silent",
              },
              {
                Bot: "**Internal helpdesk bot**",
                "What it does":
                  "IT/HR/policy answers via [RAG over your docs](/services/generative-ai-development/), ticket creation with clean triage",
                "The line it never crosses":
                  "Permission-aware retrieval: [the intern's bot can't read the CFO's folder](/services/generative-ai-development/)",
              },
              {
                Bot: "**Lead-capture & intake bot**",
                "What it does":
                  "Qualification conversations, form-filling by chat, [scheduling against real availability](/solutions/booking-system/)",
                "The line it never crosses":
                  "TCPA-aware follow-up; honest bot disclosure",
              },
              {
                Bot: "Voice sibling](/solutions/voice-ai ",
                "What it does": "The same grounded brain on the phone",
                "The line it never crosses":
                  "Warm-transfer thresholds tuned per stakes",
              },
            ],
          },
        ],
        cta: "[#scoping] Book a Chatbot Scoping Call\nBring your top-20 contact reasons and (if you have them) transcripts — leave with a resolution-rate forecast, a grounding plan, and a fixed quote.",
        sourceFile: "wave0-batch8/sol15-ai-chatbot-solutions.md",
      },
    },
    {
      ...
      meta: {
        ...
        description:
          "Custom analytics dashboard development development — your rules, your integrations, ownership economics. Honest build-vs-buy scoping.",
      },
      content:
      ...
      structured: {
        ...
        tables: [],
        cta: "Book a Scoping Call\nBring the workflow and the current tool's invoice — leave with the crossover math and a fixed quote.",
        sourceFile: "wave1-generated/solutions/analytics-dashboards.md",
      },
    },
    {
      ...
      meta: {
        ...
        description:
          "Custom appointment scheduling software development — your rules, your integrations, ownership economics. Honest build-vs-buy scoping.",
      },
      content:
      ...
      structured: {
        ...
        tables: [],
        cta: "Book a Scoping Call\nBring the workflow and the current tool's invoice — leave with the crossover math and a fixed quote.",
        sourceFile: "wave1-generated/solutions/appointment-scheduling.md",
      },
    },
    {
      ...
      meta: {
        ...
        description:
          "Custom business intelligence dashboards development — your rules, your integrations, ownership economics. Honest build-vs-buy scoping.",
      },
      content:
      ...
      structured: {
        ...
        tables: [],
        cta: "Book a Scoping Call\nBring the workflow and the current tool's invoice — leave with the crossover math and a fixed quote.",
        sourceFile: "wave1-generated/solutions/bi-dashboards.md",
      },
    },
    {
      ...
      structured: {
        faqs: [
          ...
          {
            question: "We take deposits — any compliance issues?",
            answer:
              "Deposit, cancellation, and refund policies get encoded per your terms with state-consumer-rule awareness, card handling stays [PCI-minimized](/resources/security-compliance/pci-dss-applications-payments/) via Stripe-hosted fields, and clinical contexts get the [HIPAA treatment](/industries/healthcare/). Your policies, engineered enforceable.",
          },
          {
            question: "Can an AI agent take bookings by phone?",
            answer:
              "Yes — [voice agents](/solutions/voice-ai/) against the real availability engine, with graceful human handoff and accuracy measured before autonomy. After-hours booking capture is where it pays first.",
          },
          {
        ...
        tables: [
          {
            headers: ["Module", "What it encodes"],
            rows: [
              {
                Module: "**Availability engine (the heart)**",
                "What it encodes":
                  "Resources (staff, rooms, vehicles, equipment) × skills × zones × buffers × dependencies — availability computed live, never hand-maintained",
              },
              {
                Module: "**Customer booking flow**",
                "What it encodes":
                  "Mobile-first, sub-minute, [conversion-designed](/resources/ui-ux-design/form-design-conversion/) — service selection, real-time slots, account-optional checkout",
              },
              {
                Module: "**Payments & deposits**",
                "What it encodes":
                  "[Stripe-integrated](/platforms/stripe/) deposits, full prepay, packages, no-show fees per your policy — with the state-rule awareness deposits deserve",
              },
              {
                Module: "**Reminders & no-show defense**",
                "What it encodes":
                  "SMS/email sequences, confirm/reschedule links, waitlist backfill when slots open — the module that pays for the system",
              },
              {
                Module: "**Staff & resource calendars**",
                "What it encodes":
                  "The back-office truth: drag-reschedule with rule enforcement, day/route views for [field crews](/solutions/field-service-management/), turnover blocks automated",
              },
              {
                Module: "**Recurring & package logic**",
                "What it encodes":
                  "Memberships, class packs, standing appointments, [subscription billing](/resources/how-to/how-to-implement-subscription-billing/) where the model demands",
              },
              {
                Module: "**Multi-location & franchise**",
                "What it encodes":
                  "Location-scoped rules under one brand, roll-up [reporting](/solutions/analytics-dashboards/), central or local control per your operating model",
              },
              {
                Module: "**Intake & workflow**",
                "What it encodes":
                  "Custom forms per service, document collection, [HIPAA-grade handling](/industries/healthcare/) where clinical context requires",
              },
              {
                Module: "AI layer](/services/ai-application-development ",
                "What it encodes":
                  'Booking agents on web/phone/SMS that answer "can you do Thursday near Elm St?" against the real availability engine — with [human handoff](/services/ai-agent-development/) and measured accuracy',
              },
            ],
          },
        ],
        cta: "[#scoping] Book a Booking-System Scoping Call\nBring Maria (seriously) — leave with your availability rules documented, an architecture sketch, and a fixed quote.",
        sourceFile: "wave0-batch7/sol05-booking-system.md",
      },
    },
    {
      ...
      structured: {
        faqs: [
          ...
          {
            question: "How fast is the first payback?",
            answer:
              "First automation live 4–8 weeks after the audit, baseline-measured — and it's deliberately chosen from the high-certainty end of the portfolio so the program's first number is a win your CFO can check.",
          },
          {
        ...
        tables: [
          {
            headers: ["Instrument", "Right when the step is…", "Wrong when…"],
            rows: [
              {
                Instrument: "Integration](/services/api-development ",
                "Right when the step is…":
                  "Data moving between systems that both have APIs — the permanent fix",
                "Wrong when…":
                  "Used as an excuse to rebuild systems that just needed connecting",
              },
              {
                Instrument:
                  "Workflow engine](/solutions/workflow-automation ",
                "Right when the step is…":
                  "Approvals, handoffs, SLAs — *human* steps needing tracking and enforcement",
                "Wrong when…":
                  "Applied to steps that shouldn't involve humans at all",
              },
              {
                Instrument: "RPA](/solutions/rpa-development ",
                "Right when the step is…":
                  "Rule-perfect clicking in systems *without* APIs — the pragmatic bridge",
                "Wrong when…":
                  "Sold as strategy; bots on top of chaos automate the chaos",
              },
              {
                Instrument: "AI agents](/solutions/ai-agents ",
                "Right when the step is…":
                  "Judgment-before-action on messy inputs (emails, documents, exceptions) — with [approval gates](/services/ai-agent-development/)",
                "Wrong when…":
                  "Deployed where rules would do (pay the AI premium only for judgment)",
              },
              {
                Instrument:
                  "Document intelligence](/services/generative-ai-development ",
                "Right when the step is…":
                  "Unstructured paper/PDF/email becoming structured data at intake",
                "Wrong when…":
                  "Expected to fix downstream process problems it merely feeds",
              },
              {
                Instrument: "**Custom software**",
                "Right when the step is…":
                  "The process needs a *system of record* that doesn't exist — [the spreadsheet ceiling](/industries/small-business/)",
                "Wrong when…":
                  "Reached for before cheaper instruments were tried",
              },
            ],
          },
        ],
        cta: '[#audit] Book an Automation Opportunity Audit\nBring the process that eats the most hours — leave with a ranked automation portfolio, per-item payback math, and the honest "don\'t automate this" column.',
        sourceFile: "wave0-batch8/sol13-business-process-automation.md",
      },
    },
    {
      ...
      meta: {
        ...
        description:
          "Custom clinic management system development — your rules, your integrations, ownership economics. Honest build-vs-buy scoping.",
      },
      content:
      ...
      structured: {
        ...
        tables: [],
        cta: "Book a Scoping Call\nBring the workflow and the current tool's invoice — leave with the crossover math and a fixed quote.",
        sourceFile: "wave1-generated/solutions/clinic-management-system.md",
      },
    },
    {
      ...
      meta: {
        ...
        description:
          "Custom contract management software development — your rules, your integrations, ownership economics. Honest build-vs-buy scoping.",
      },
      content:
      ...
      structured: {
        ...
        tables: [],
        cta: "Book a Scoping Call\nBring the workflow and the current tool's invoice — leave with the crossover math and a fixed quote.",
        sourceFile: "wave1-generated/solutions/contract-management.md",
      },
    },
    {
      ...
      related: {
        ...
        solutions: [],
        platforms: ["/platforms/salesforce/", "/platforms/hubspot/"],
        technologies: [],
        industries: [
      ...
      structured: {
        faqs: [
          {
            question: "Can you migrate our Salesforce/HubSpot data?",
            answer:
              "Yes — history, notes, attachments, and the custom-field archaeology, with reconciliation reports proving completeness. Migration is a first-class workstream, not an afterthought.",
          },
          {
            question: "How long until the team is on it?",
            answer:
              "First working pipeline in 6–8 weeks on staging; phased go-live by team; full cutover typically month 4–6 with parallel-run safety.",
          },
          {
            question: "Can AI work our leads?",
            answer:
              "Speed-to-lead agents that respond, qualify, and book within seconds — with [approval gates and measured accuracy](/services/ai-agent-development/) before autonomy. It's the highest-ROI CRM add-on of 2026, and it works better on a CRM shaped like your process.",
          },
        ],
        tables: [
          {
            headers: ["Module", "What it does, your way"],
            rows: [
              {
                Module: "**Pipeline & deal management**",
                "What it does, your way":
                  "Your stages, your qualification rules, your close process — enforced by the system, not a training doc",
              },
              {
                Module: "**Contact & account model**",
                "What it does, your way":
                  "Your actual entity shapes (multi-site accounts, broker hierarchies, family relationships) — the part platforms fight you on",
              },
              {
                Module: "**Activity & communication capture**",
                "What it does, your way":
                  "Email/calendar sync, call logging, texting (TCPA-aware) — with the timeline view sales actually reads",
              },
              {
                Module: "**Quoting & proposals**",
                "What it does, your way":
                  "Your pricing logic generating branded quotes — the module that pays for the build in most cases",
              },
              {
                Module: "**Commission & incentive math**",
                "What it does, your way":
                  "Splits, tiers, clawbacks — computed, auditable, argument-ending",
              },
              {
                Module: "**Automation & follow-up**",
                "What it does, your way":
                  "Lead routing, drip sequences, task creation, SLA timers — [workflow engine](/solutions/workflow-automation/) underneath",
              },
              {
                Module: "**Reporting & forecasting**",
                "What it does, your way":
                  "Pipeline math leadership trusts, cohort win rates, rep [scorecards](/solutions/analytics-dashboards/)",
              },
              {
                Module: "AI layer](/services/ai-application-development ",
                "What it does, your way":
                  "Lead-response agents (speed-to-lead in seconds), call/email summarization into the record, next-step suggestions with rep approval",
              },
            ],
          },
        ],
        cta: "[#scoping] Request a CRM Scoping Call\nBring your seat count, your subscription invoices, and your messiest workflow — leave with the crossover math and a fixed quote.",
        sourceFile: "wave0-batch7/sol01-crm-development.md",
      },
    },
    {
      ...
      meta: {
        title:
          "Custom CRM Development | Built Around Your Sales Process | Clickmasters",
        description:
          "Custom CRM built around how you actually sell — your pipeline, your integrations, your data. With honest math on when Salesforce is the better buy.",
      },
      content:
      ...
      structured: {
        faqs: [
          ...
          {
            question: "Can we migrate off Salesforce cleanly?",
            answer:
              "Yes — parallel-run migration with reconciliation; the harder work is re-encoding process knowledge living in flows and admin heads, which the assessment maps first.",
          },
          {
            question: "What if we only need part of it custom?",
            answer:
              "Common and often optimal: keep the platform as system-of-record, build the differentiated workflow beside it, integrate cleanly.",
          },
        ],
        tables: [],
        cta: "Get a Quote in 24 Hours\nTell us what you're building — honest read, fixed number, no pitch attached.",
        sourceFile: "wave2-core/gap-pages/solutions-custom-crm-solutions.md",
      },
    },
    {
      ...
      meta: {
        ...
        description:
          "Custom customer portal development development — your rules, your integrations, ownership economics. Honest build-vs-buy scoping.",
      },
      content:
      ...
      structured: {
        ...
        tables: [],
        cta: "Book a Scoping Call\nBring the workflow and the current tool's invoice — leave with the crossover math and a fixed quote.",
        sourceFile: "wave1-generated/solutions/customer-portal.md",
      },
    },
    {
      ...
      meta: {
        ...
        description:
          "Custom digital wallet development development — your rules, your integrations, ownership economics. Honest build-vs-buy scoping.",
      },
      content:
      ...
      structured: {
        ...
        tables: [],
        cta: "Book a Scoping Call\nBring the workflow and the current tool's invoice — leave with the crossover math and a fixed quote.",
        sourceFile: "wave1-generated/solutions/digital-wallet.md",
      },
    },
    {
      ...
      meta: {
        ...
        description:
          "Custom document management system development — your rules, your integrations, ownership economics. Honest build-vs-buy scoping.",
      },
      content:
      ...
      structured: {
        ...
        tables: [],
        cta: "Book a Scoping Call\nBring the workflow and the current tool's invoice — leave with the crossover math and a fixed quote.",
        sourceFile: "wave1-generated/solutions/document-management-system.md",
      },
    },
    {
      ...
      meta: {
        title:
          "AI Document Processing & Extraction | Invoice, Claims & Forms | Clickmasters",
        description:
          "AI document processing — extract structured data from invoices, claims, contracts, and forms with measured accuracy and human review where it matters.",
      },
      content:
      ...
      structured: {
        faqs: [
          ...
          {
            question: "Does it replace our AP or claims team?",
            answer:
              "Typically it removes the retyping and lets the same team handle 3–5× volume with exceptions-only attention — headcount reduction is a choice you make, not one the software forces.",
          },
        ],
        tables: [],
        cta: "Get a Quote in 24 Hours\nTell us what you're building — honest read, fixed number, no pitch attached.",
        sourceFile: "wave2-core/gap-pages/solutions-document-processing.md",
      },
    },
    {
      ...
      structured: {
        faqs: [
          {
            question: "Do we need ONC certification?",
            answer:
              "Only if your customers need certified technology — chiefly for CMS promoting-interoperability programs and certain payer requirements. Cash-pay specialties, many behavioral-health models, and clinical layers inside broader products often don't. This is a go-to-market decision with a seven-figure swing attached; we'll map it with you (and your regulatory advisor) before any code is scoped.",
          },
          {
            question: "Can you connect us to Surescripts for e-prescribing?",
            answer:
              "Via certified e-prescribing integration partners, yes — that's the standard architecture for new EHRs, and the honest one: the certified rails exist to be integrated, not reinvented. EPCS (controlled substances) adds identity-proofing and two-factor requirements we scope explicitly.",
          },
          {
          ...
          {
            question: "Where does AI belong in an EHR today?",
            answer:
              "Documentation burden first — ambient-note integration, summarization, coding suggestions — the measurable, clinician-approved layer. Diagnostic AI crosses into SaMD territory with FDA implications; we'll name that line clearly and design on whichever side you choose deliberately.",
          },
          {
            question: "How long to a sellable v1?",
            answer:
              "Specialty EHR: 6–10 months to a pilot-practice-ready build, with certification (if pursued) tracked in parallel — sequenced so early customers and regulatory progress compound instead of blocking each other.",
          },
        ],
        tables: [
          {
            headers: ["Build type", "Who it's for", "Regulatory posture"],
            rows: [
              {
                "Build type": "**Specialty EHR products**",
                "Who it's for":
                  "Vendors serving a niche the giants ignore (behavioral health, PT/OT, med-spa, direct primary care, veterinary-adjacent human models)",
                "Regulatory posture":
                  "HIPAA always; ONC certification scoped honestly per go-to-market",
              },
              {
                "Build type": "**Clinical layer in digital-health platforms**",
                "Who it's for":
                  "[Telehealth](/solutions/telehealth-platform/), chronic-care, and virtual-first companies needing charting inside their product",
                "Regulatory posture":
                  "HIPAA; certification usually avoidable by design — we design it",
              },
              {
                "Build type": "**Charting & documentation modules**",
                "Who it's for":
                  "Practices whose specialty workflow fights their current EHR",
                "Regulatory posture":
                  "Integrates with the incumbent rather than replacing it",
              },
              {
                "Build type": "**EHR-companion apps**",
                "Who it's for": "Products that read/write the big EHRs",
                "Regulatory posture":
                  "[FHIR/SMART-on-FHIR](/resources/industry-insights/hl7-fhir-integration-primer/), vendor app-program navigation",
              },
              {
                "Build type":
                  "Clinic-management pairing](/solutions/clinic-management-system ",
                "Who it's for":
                  "Full practice platforms: clinical + scheduling + billing workflows",
                "Regulatory posture":
                  "The combined build most specialty vendors actually need",
              },
            ],
          },
        ],
        cta: "[#scoping] Book an EHR Scoping Call\nBring the specialty, the go-to-market, and the certification question — leave with your spot on the regulatory spectrum and a phased quote that respects it.",
        sourceFile: "wave0-batch8/sol09-ehr-emr-software.md",
      },
    },
    {
      ...
      meta: {
        ...
        description:
          "Custom employee portal development development — your rules, your integrations, ownership economics. Honest build-vs-buy scoping.",
      },
      content:
      ...
      structured: {
        ...
        tables: [],
        cta: "Book a Scoping Call\nBring the workflow and the current tool's invoice — leave with the crossover math and a fixed quote.",
        sourceFile: "wave1-generated/solutions/employee-portal.md",
      },
    },
    {
      ...
      structured: {
        faqs: [
          {
            question: "Isn't custom ERP risky? We've heard the horror stories.",
            answer:
              "The horror stories are big-bang stories — all modules, one cutover, discovered requirements. Module-by-module delivery inverts the risk curve: small blast radius, value each quarter, and the option to stop after any module with everything shipped still working. The [governance mechanics](/services/enterprise-software-development/) are the answer to the horror stories, not a personality claim.",
          },
          {
            question: "Do we replace QuickBooks/NetSuite?",
            answer:
              "Usually no — keep the financial core, build the operational layer, integrate cleanly with reconciliation reports. Rebuilding general-ledger accounting is almost never the highest-value module; we'll say so even though it would bill more.",
          },
          {
            question: "How do you handle our weird processes?",
            answer:
              "Your weird processes are the point — they're usually where you win. Discovery documents them from the people who run them (not just the org chart), and the modules encode them. The platforms' \"best practices\" are averages; you're not average, or you wouldn't be reading this page.",
          },
          {
            question: "What about our data in the old system?",
            answer:
              "[Migration as a formal workstream](/services/data-migration/): profiling, cleansing rules your data owners sign, rehearsed runs, reconciliation counts, rollback. Twenty years of data has twenty years of surprises; rehearsal keeps them boring.",
          },
          {
            ...
            rows: [
              {
                ...
                "The operational job":
                  "Quote → order → fulfillment → invoice trigger, with your rules",
                "Typical sequence position":
                  "Usually first — it touches everything",
              },
              {
                Module:
                  "Inventory & purchasing](/solutions/inventory-management-system ",
                "The operational job":
                  "Stock truth, reorder logic, PO workflows, receiving",
                "Typical sequence position":
                  "First or second — [the reconciliation engine](/industries/retail/)",
              },
              {
                Module: "**Production / job tracking**",
                "The operational job":
                  "Work orders, BOMs, routing, costing — [the plant layer](/industries/manufacturing/)",
                "Typical sequence position":
                  "Manufacturing's usual entry point",
              },
              {
                Module:
                  "Warehouse ops](/solutions/warehouse-management-system ",
                "The operational job": "Pick/pack/ship, scanner-first",
                "Typical sequence position":
                  "Where fulfillment volume demands it",
              },
              {
                Module: "**Purchasing & vendor management**",
                "The operational job":
                  "Requisitions, approvals, vendor scorecards, [portals](/solutions/vendor-portal/)",
                "Typical sequence position": "Mid-sequence",
              },
              {
                Module: "**Financial integration layer**",
                "The operational job":
                  "Every operational event posting cleanly to your accounting core, with [reconciliation reports](/services/api-development/)",
                "Typical sequence position":
                  "Built with module one, extended forever",
              },
              {
                Module:
                  "Workflow & approvals](/solutions/workflow-automation ",
                "The operational job":
                  "The approval chains currently living in email",
                "Typical sequence position": "Woven through every module",
              },
              {
                Module:
                  "Reporting & dashboards](/solutions/bi-dashboards ",
                "The operational job":
                  "One version of operational truth by role",
                "Typical sequence position":
                  "Delivered incrementally with each module",
              },
              {
                Module: "AI layer](/services/ai-application-development ",
                "The operational job":
                  "Document intelligence (POs, invoices, order emails → structured data), demand-forecast assist, exception-triage agents",
                "Typical sequence position":
                  "After the data foundation exists — honestly sequenced",
              },
            ],
          },
        ],
        cta: "[#scoping] Book an ERP Scoping Call\nBring the process map (or the spreadsheet standing in for one) — leave with a module sequence, the hybrid-vs-platform math, and a module-one quote.",
        sourceFile: "wave0-batch7/sol02-erp-development.md",
      },
    },
    {
      ...
      meta: {
        ...
        description:
          "Custom field service management development — your rules, your integrations, ownership economics. Honest build-vs-buy scoping.",
      },
      content:
      ...
      structured: {
        ...
        tables: [],
        cta: "Book a Scoping Call\nBring the workflow and the current tool's invoice — leave with the crossover math and a fixed quote.",
        sourceFile: "wave1-generated/solutions/field-service-management.md",
      },
    },
    {
      ...
      structured: {
        faqs: [
          ...
          {
            question: "Will this replace our ELD?",
            answer:
              "No, and be suspicious of anyone offering to — ELDs are certified, registered devices. We consume their data and build your operation around it: the compliant architecture and the honest one.",
          },
          {
            question: "Can it actually predict breakdowns?",
            answer:
              "Where your fault-code and repair history supports it, meaningfully yes — pattern-flagged components queued for inspection before failure. Where history is thin, we start with disciplined trigger-based PM (which most fleets haven't actually achieved) and let the data mature into prediction. [The honest AI sequencing →](/services/ai-application-development/)",
          },
          {
            question: "Our drivers won't adopt another app.",
            answer:
              "They'll adopt one that's faster than paper: DVIR in ninety seconds with photos, [big-target gloves-and-glare UX](/industries/logistics/), offline-tolerant. Pilot with your most skeptical drivers first — that's the method, and their complaints shape v1.1 before rollout.",
          },
          {
          ...
          {
            question: "How long to first value?",
            answer:
              "Maintenance + telematics core live in 3–4 months, with the baseline (unplanned downtime, PM compliance rate) measured first so the improvement is auditable arithmetic.",
          },
        ],
        tables: [
          {
            ...
            rows: [
              {
                Module: "**Telematics integration (the foundation)**",
                "What it does":
                  "Positions, faults, harsh events, HOS, fuel data normalized from Samsara/Motive/Geotab/Verizon-class feeds — [deduped, gap-tolerant](/industries/logistics/), one schema regardless of mixed hardware",
              },
              {
                Module: "**Live fleet view & dispatch**",
                "What it does":
                  "Assets + jobs on one map, assignment with rule enforcement (class, licensing, zones), [routing where delivery models need it](/solutions/on-demand-delivery/)",
              },
              {
                Module: "**Maintenance management**",
                "What it does":
                  "PM schedules by *your* triggers (miles, hours, faults, duty cycle), work orders, parts, downtime tracking — the module that pays for the build",
              },
              {
                Module: "**DVIR & inspections**",
                "What it does":
                  "Driver vehicle inspection reports on mobile with photo evidence, defect-to-work-order flow, audit-ready trails",
              },
              {
                Module: "**IFTA & fuel**",
                "What it does":
                  "Jurisdiction-mile computation from telematics data, fuel-purchase reconciliation, quarter-close reports that stop being a spreadsheet weekend",
              },
              {
                Module: "**Driver safety & coaching**",
                "What it does":
                  "Harsh-event review queues, scorecards [framed for coaching, not surveillance theater](/industries/manufacturing/), training-assignment hooks",
              },
              {
                Module: "**Asset lifecycle**",
                "What it does":
                  "Utilization, cost-per-mile per asset, replacement modeling — the CFO layer",
              },
              {
                Module:
                  "Customer visibility](/solutions/customer-portal ",
                "What it does":
                  "ETA sharing and delivery status where your fleet serves customers directly",
              },
              {
                Module: "Fleet AI](/services/ai-application-development ",
                "What it does":
                  "Predictive-maintenance signals where fault history supports them, dispatch-assist with human approval, [document intelligence](/services/generative-ai-development/) on fuel receipts and repair invoices",
              },
            ],
          },
        ],
        cta: "[#consult] Book a Fleet Software Consultation\nBring the telematics login, the maintenance log, and the IFTA spreadsheet — leave with an integration map and a maintenance-first phased quote.",
        sourceFile: "wave0-batch8/sol12-fleet-management.md",
      },
    },
    {
      ...
      meta: {
        ...
        description:
          "Custom fraud detection systems development — your rules, your integrations, ownership economics. Honest build-vs-buy scoping.",
      },
      content:
      ...
      structured: {
        ...
        tables: [],
        cta: "Book a Scoping Call\nBring the workflow and the current tool's invoice — leave with the crossover math and a fixed quote.",
        sourceFile: "wave1-generated/solutions/fraud-detection.md",
      },
    },
    {
      ...
      structured: {
        faqs: [
          {
            question: "We have Epic/Cerner. Why would we need anything else?",
            answer:
              "You might not — and we'll say so if your pain is inside the EHR's lane. But EHRs are clinical-record systems; facility operations (beds, turnover, transport, discharge choreography, staff scheduling) are famously underserved by their modules, priced painfully when served, and queued years out. The between-system layer is where targeted builds win on speed and fit.",
          },
          {
          ...
          {
            question: "What about downtime? We run 24/7.",
            answer:
              "Designed for it: unit-by-unit rollout, no big-bang cutovers, offline-tolerant clients for network blips, and documented downtime procedures (including paper fallback forms that match the digital flow) as a standard deliverable.",
          },
          {
            question: "How long until the first module is live?",
            answer:
              "3–5 months for a focused module including interface work — with the baseline metric (bed turnover, discharge time) measured before go-live so the improvement is a number your CFO can audit.",
          },
        ],
        tables: [
          {
            headers: [
              "Module",
              "The operational job",
              "Between-system reality it fixes",
            ],
            rows: [
              {
                Module: "**ADT & patient flow**",
                "The operational job":
                  "Admissions, transfers, discharge coordination with task choreography",
                "Between-system reality it fixes":
                  "The discharge that takes 6 hours of phone tag after the physician order",
              },
              {
                Module: "**Bed management**",
                "The operational job":
                  "Live bed status: occupied, dirty, clean, blocked, projected",
                "Between-system reality it fixes":
                  "The whiteboard — and the ED boarding it causes",
              },
              {
                Module: "**Departmental workflow**",
                "The operational job":
                  "Order-to-result tracking for lab/radiology; pharmacy queues; dietary/housekeeping/transport tasking",
                "Between-system reality it fixes":
                  "Requests that vanish between departments",
              },
              {
                Module: "**Staff scheduling**",
                "The operational job":
                  "Shift patterns, credentials-aware assignment, float management, [swap workflows](/solutions/workflow-automation/)",
                "Between-system reality it fixes":
                  "The spreadsheet the charge nurse maintains at 5 a.m.",
              },
              {
                Module:
                  "Appointment & resource scheduling](/solutions/appointment-scheduling ",
                "The operational job":
                  "OR/procedure-room/equipment scheduling with turnover rules",
                "Between-system reality it fixes":
                  "Double-booked rooms and idle blocks",
              },
              {
                Module: "**Billing & revenue-cycle workflows**",
                "The operational job":
                  "Charge capture, claim-prep queues, denial worklists — [integrating with](/services/api-development/), not replacing, your billing core",
                "Between-system reality it fixes":
                  "Charges leaking between care and claim",
              },
              {
                Module:
                  "Patient & family portal](/solutions/patient-portal ",
                "The operational job": "Status visibility, forms, payments",
                "Between-system reality it fixes":
                  'The waiting-room "any update?" traffic',
              },
              {
                Module:
                  "**Executive [dashboards](/solutions/analytics-dashboards ",
                "The operational job":
                  "Census, throughput, LOS, department SLAs — live, not month-end",
                "Between-system reality it fixes":
                  "Decisions made on last month's numbers",
              },
              {
                Module:
                  "Hospital AI](/services/ai-application-development ",
                "The operational job":
                  "Discharge-barrier prediction, transport/housekeeping dispatch optimization, document intelligence on referrals — [clinician-in-the-loop always](/resources/ai-development/human-in-the-loop-ai/)",
                "Between-system reality it fixes": "—",
              },
            ],
          },
        ],
        cta: "[#consult] Book a Hospital Systems Consultation\nBring the whiteboard, the pager workflow, and the interface list — leave with a between-system module map and a phased quote.",
        sourceFile: "wave0-batch8/sol08-hospital-management-system.md",
      },
    },
    {
      ...
      meta: {
        ...
        description:
          "Custom hrms development development — your rules, your integrations, ownership economics. Honest build-vs-buy scoping.",
      },
      content:
      ...
      structured: {
        ...
        tables: [],
        cta: "Book a Scoping Call\nBring the workflow and the current tool's invoice — leave with the crossover math and a fixed quote.",
        sourceFile: "wave1-generated/solutions/hrms-development.md",
      },
    },
    {
      ...
      structured: {
        faqs: [
          {
            question: "Our counts are always wrong. Will software fix that?",
            answer:
              "Software + capture UX + cycle-count discipline will; software alone won't. That's why the scanner-first workflows and count scheduling are core modules, not add-ons — accuracy is a system of habits the software must make easier than the alternative.",
          },
          {
            question: "Can it sync our Shopify, Amazon, and store POS?",
            answer:
              "Yes — one ledger, per-channel buffers, idempotent event handling, reconciliation against each platform's reports. [Multi-channel truth is the flagship use case.](/industries/ecommerce/)",
          },
          {
          ...
          {
            question: "What about our existing barcodes and labels?",
            answer:
              "We work with your existing symbologies and generate what's missing (label design and print integration included). No forced re-labeling project unless the current scheme is genuinely broken — and we'll show you if it is.",
          },
          {
            question: "How disruptive is go-live?",
            answer:
              "A rehearsed opening count sets the baseline (usually a weekend), then the system runs parallel-visible while teams shift transaction by transaction. No stop-the-business cutover; accuracy converges within the first cycle-count period.",
          },
          {
        ...
        tables: [
          {
            ...
            rows: [
              {
                Module: "**Stock ledger (the heart)**",
                "What it does":
                  "Append-only movement history per SKU/lot/serial per location — balances derived, never edited; every adjustment reasoned and attributed",
              },
              {
                Module: "**Scanner-first transactions**",
                "What it does":
                  "Receive, putaway, pick, transfer, count, adjust — barcode/QR flows [faster than the clipboard](/resources/ui-ux-design/enterprise-ux-power-users/), on rugged devices or phones",
              },
              {
                Module: "**Multi-location & multi-channel sync**",
                "What it does":
                  "Stores, warehouses, 3PLs, vans; [web, POS, marketplaces](/industries/retail/) decrementing one truth with per-channel buffers — oversells end here",
              },
              {
                Module: "**Purchasing & replenishment**",
                "What it does":
                  "Reorder points, lead-time-aware suggestions, PO generation and receiving reconciliation",
              },
              {
                Module: "**Cycle counting**",
                "What it does":
                  "ABC-scheduled counts that replace the annual shutdown count, with variance workflows",
              },
              {
                Module: "**Lot/serial & expiry tracking**",
                "What it does":
                  "Traceability where your product demands it — [recall-ready](/industries/manufacturing/) where-used in minutes",
              },
              {
                Module: "**Kitting & assemblies**",
                "What it does":
                  "BOM-based builds and breaks with component consumption",
              },
              {
                Module: "Reporting](/solutions/analytics-dashboards ",
                "What it does":
                  "Turns, aging, shrink flags, stockout risk — by SKU/location, trusted because the ledger underneath is",
              },
              {
                Module: "AI layer](/services/ai-application-development ",
                "What it does":
                  "Demand-forecast assist where history supports it, anomaly flags (shrink patterns, count drift), document intelligence on supplier paperwork",
              },
            ],
          },
        ],
        cta: "[#scoping] Book an Inventory Scoping Call\nBring the SKU count, the location map, and last month's count variance — leave with an architecture sketch and the build-vs-buy crossover math.",
        sourceFile: "wave0-batch7/sol03-inventory-management.md",
      },
    },
    {
      ...
      meta: {
        title:
          "IoT Development Company | Connected Devices, Dashboards & Platforms | Clickmasters",
        description:
          "IoT solutions — device connectivity, ingestion pipelines, dashboards, and alerts. Built for the messy reality of field hardware and intermittent networks.",
      },
      content:
      ...
      structured: {
        faqs: [
          {
            question: "What does an IoT platform cost?",
            answer:
              "Focused monitoring builds commonly $40K–$100K; full platforms with fleet management, analytics, and integrations $100K–$250K+. Device hardware is separate and usually sourced.",
          },
          {
            question: "Do you do the hardware too?",
            answer:
              "We build the software layer and integrate with your chosen hardware or hardware partner — firmware and device selection we scope collaboratively rather than pretend to own.",
          },
          {
        ...
        tables: [],
        cta: "Get a Quote in 24 Hours\nTell us what you're building — honest read, fixed number, no pitch attached.",
        sourceFile: "wave2-core/gap-pages/solutions-iot-solutions.md",
      },
    },
    {
      ...
      structured: {
        faqs: [
          ...
          {
            question: "Do you support SCORM? Our content library is huge.",
            answer:
              "Yes — SCORM 1.2/2004 and xAPI players so your existing library runs day one, with native authoring available for everything you build next. No forced content-migration project.",
          },
          {
          ...
          {
            question: "What about mobile learning?",
            answer:
              "Responsive-first always; [native apps](/services/mobile-app-development/) where offline learning or push-driven engagement justifies them — a build-case question we'll answer with your learner data, not reflexively.",
          },
          {
        ...
        tables: [
          {
            headers: [
              "Module",
              "What it does",
              "Which LMS-business it serves hardest",
            ],
            rows: [
              {
                Module: "**Course & curriculum engine**",
                "What it does":
                  "Paths, prerequisites, cohorts, drip schedules, versioned content",
                "Which LMS-business it serves hardest": "All three",
              },
              {
                Module: "**Content delivery**",
                "What it does":
                  "Video (protected streaming), documents, interactive lessons, **SCORM/xAPI players** for the legacy-content world",
                "Which LMS-business it serves hardest":
                  "Compliance & L&D inherit content; revenue builds native",
              },
              {
                Module: "**Assessment & certification**",
                "What it does":
                  "Quizzes, item banks, proctoring-integration options, certificates with verification pages, **recertification clocks**",
                "Which LMS-business it serves hardest":
                  "Compliance & cert bodies",
              },
              {
                Module: "**Completion & audit records**",
                "What it does":
                  "Immutable training evidence: who, what, when, score, version trained on — [exam-ready](/resources/architecture/designing-for-auditability/)",
                "Which LMS-business it serves hardest":
                  "Compliance — this module *is* the product",
              },
              {
                Module:
                  "**Commerce & [subscriptions](/resources/how-to/how-to-implement-subscription-billing ",
                "What it does":
                  "Course sales, memberships, seat licensing, B2B invoicing, coupons/affiliates",
                "Which LMS-business it serves hardest": "Revenue",
              },
              {
                Module: "**Engagement machinery**",
                "What it does":
                  "Progress mechanics, reminders, streaks-used-tastefully, cohort features — [engineered against the week-two cliff](/resources/industry-insights/edtech-product-design-engagement/)",
                "Which LMS-business it serves hardest": "Revenue & L&D",
              },
              {
                Module: "**Instructor & admin tools**",
                "What it does":
                  "Authoring workflows, gradebooks, cohort management, assignment engines by role/department",
                "Which LMS-business it serves hardest": "All three",
              },
              {
                Module: "Reporting](/solutions/analytics-dashboards ",
                "What it does":
                  "Completion by team/course/cohort, drop-off maps, compliance-status dashboards",
                "Which LMS-business it serves hardest":
                  "All three, differently",
              },
              {
                Module:
                  "Learning AI](/services/ai-application-development ",
                "What it does":
                  "Tutoring assistants with [pedagogy guardrails](/industries/education/), quiz generation with instructor approval, content-gap analysis",
                "Which LMS-business it serves hardest":
                  "Honest boundaries per the education practice",
              },
            ],
          },
        ],
        cta: "[#scoping] Book an LMS Scoping Call\nBring which of the three LMS businesses you're in (or let us ask) — leave with a module map, the seat-fee crossover math, and a phased quote.",
        sourceFile: "wave0-batch8/sol10-lms-development.md",
      },
    },
    {
      ...
      meta: {
        ...
        description:
          "Custom loan management software development — your rules, your integrations, ownership economics. Honest build-vs-buy scoping.",
      },
      content:
      ...
      structured: {
        ...
        tables: [],
        cta: "Book a Scoping Call\nBring the workflow and the current tool's invoice — leave with the crossover math and a fixed quote.",
        sourceFile: "wave1-generated/solutions/loan-management.md",
      },
    },
    {
      ...
      structured: {
        faqs: [
          {
            question: "Can we launch without building all of this?",
            answer:
              "You should — that's the wedge method above. Several successful clients ran their first hundred transactions on our booking-and-payments core plus founder elbow grease, then funded automation from proven take-rate. [MVP discipline →](/services/mvp-development/)",
          },
          {
            question: "How do payments and payouts work legally?",
            answer:
              "Via Connect-class rails that keep you out of money-transmitter territory in standard models — platform fee to you, payout to sellers, 1099-K handling at the processor layer — with flow-of-funds designed alongside [your counsel](/industries/fintech/) when your model gets creative. The engineering and the legal theory must match; we build so they do.",
          },
          {
        ...
        tables: [
          {
            ...
            rows: [
              {
                Module: "**Supply onboarding**",
                "What it does":
                  "Seller/provider signup, verification (identity, licenses, KYC where [payouts demand](/industries/fintech/)), listing creation that doesn't lose them at step 3",
              },
              {
                Module: "**Discovery & matching**",
                "What it does":
                  "Search, filters, [semantic matching](/solutions/recommendation-engines/), and the ranking logic that *is* your marketplace's editorial voice",
              },
              {
                Module: "**Transaction flow**",
                "What it does":
                  "Booking/ordering/quoting per your model — instant-book vs request-based vs bid-based, [availability engines](/solutions/booking-system/) where scheduling applies",
              },
              {
                Module: "**Payments, splits & payouts**",
                "What it does":
                  "[Stripe Connect-class](/platforms/stripe/) rails: platform fees, seller payouts, refund flows, 1099-K reality — with [ledger discipline](/resources/architecture/fintech-ledger-reference-architecture/), because a marketplace is quietly a fintech",
              },
              {
                Module: "**Trust machinery**",
                "What it does":
                  "Two-sided reviews (gamed-review defenses included), dispute workflows, guarantees/escrow patterns where deal size warrants",
              },
              {
                Module: "**Messaging**",
                "What it does":
                  "In-platform chat with the [anti-leakage design](#leakage) below",
              },
              {
                Module: "**Seller tools**",
                "What it does":
                  "Dashboards, calendars, pricing tools, performance analytics — the side that makes supply *stay*",
              },
              {
                Module: "**Admin & ops console**",
                "What it does":
                  "Moderation queues, verification review, dispute resolution, category management — the third product everyone forgets to scope",
              },
              {
                Module: "AI layer](/services/ai-application-development ",
                "What it does":
                  "Listing-quality assist, matching improvement, fraud/anomaly flags, [support agents](/solutions/ai-chatbot-solutions/) with order context",
              },
            ],
          },
        ],
        cta: "[#strategy] Book a Marketplace Strategy Call\nBring the two sides and the wedge you're considering — leave with a liquidity plan, an anti-leakage design, and a phased quote.",
        sourceFile: "wave0-batch7/sol07-marketplace-development.md",
      },
    },
    {
      ...
      meta: {
        ...
        description:
          "Custom membership management software development — your rules, your integrations, ownership economics. Honest build-vs-buy scoping.",
      },
      content:
      ...
      structured: {
        ...
        tables: [],
        cta: "Book a Scoping Call\nBring the workflow and the current tool's invoice — leave with the crossover math and a fixed quote.",
        sourceFile: "wave1-generated/solutions/membership-management.md",
      },
    },
    {
      ...
      meta: {
        ...
        description:
          "Custom on-demand delivery apps development — your rules, your integrations, ownership economics. Honest build-vs-buy scoping.",
      },
      content:
      ...
      structured: {
        ...
        tables: [],
        cta: "Book a Scoping Call\nBring the workflow and the current tool's invoice — leave with the crossover math and a fixed quote.",
        sourceFile: "wave1-generated/solutions/on-demand-delivery.md",
      },
    },
    {
      ...
      meta: {
        ...
        description:
          "Custom patient portal development development — your rules, your integrations, ownership economics. Honest build-vs-buy scoping.",
      },
      content:
      ...
      structured: {
        ...
        tables: [],
        cta: "Book a Scoping Call\nBring the workflow and the current tool's invoice — leave with the crossover math and a fixed quote.",
        sourceFile: "wave1-generated/solutions/patient-portal.md",
      },
    },
    {
      ...
      meta: {
        ...
        description:
          "Custom fintech payment solutions development — your rules, your integrations, ownership economics. Honest build-vs-buy scoping.",
      },
      content:
      ...
      structured: {
        ...
        tables: [],
        cta: "Book a Scoping Call\nBring the workflow and the current tool's invoice — leave with the crossover math and a fixed quote.",
        sourceFile: "wave1-generated/solutions/payment-solutions.md",
      },
    },
    {
      ...
      meta: {
        ...
        description:
          "Custom payroll software development development — your rules, your integrations, ownership economics. Honest build-vs-buy scoping.",
      },
      content:
      ...
      structured: {
        ...
        tables: [],
        cta: "Book a Scoping Call\nBring the workflow and the current tool's invoice — leave with the crossover math and a fixed quote.",
        sourceFile: "wave1-generated/solutions/payroll-software.md",
      },
    },
    {
      ...
      meta: {
        ...
        description:
          "Custom pos system development development — your rules, your integrations, ownership economics. Honest build-vs-buy scoping.",
      },
      content:
      ...
      structured: {
        ...
        tables: [],
        cta: "Book a Scoping Call\nBring the workflow and the current tool's invoice — leave with the crossover math and a fixed quote.",
        sourceFile: "wave1-generated/solutions/pos-system.md",
      },
    },
    {
      ...
      structured: {
        faqs: [
          ...
          {
            question: "Is the trust accounting actually audit-ready?",
            answer:
              "It's designed for the audit: separated ledgers, immutable histories, bank reconciliation workflows, and statement trails per owner. [State real audit outcomes when available.] If your state PM audit has specific evidentiary quirks, they become requirements, not surprises.",
          },
          {
            question: "Can tenants pay by card/ACH, and who eats the fees?",
            answer:
              "Both rails, with fee-pass-through or absorption as configuration per your policy and state rules. Autopay adoption is the delinquency lever — portal UX is designed to maximize it.",
          },
          {
            ...
            rows: [
              {
                ...
                "What it does":
                  "Applications, [screening-provider integration](/services/api-development/), lease generation with e-signature, renewals with escalation logic, move-in/out workflows",
              },
              {
                Module: "**Rent collection**",
                "What it does":
                  "ACH/card via [Stripe-class rails](/platforms/stripe/), autopay, late-fee logic as *state-aware configuration*, partial-payment rules per your policy",
              },
              {
                Module: "**Trust & owner accounting (the heart)**",
                "What it does":
                  "Trust-separated ledgers per owner/property, management-fee computation, distributions with statements owners actually understand — [ledger-disciplined](/resources/architecture/fintech-ledger-reference-architecture/), reconciled to the bank",
              },
              {
                Module: "**Maintenance operations**",
                "What it does":
                  "Tenant requests with photos, triage, [vendor dispatch](/solutions/field-service-management/), owner-approval thresholds, invoice capture to the right ledger",
              },
              {
                Module: "Tenant portal](/solutions/customer-portal ",
                "What it does":
                  "Payments, requests, documents, announcements — the call-deflection layer",
              },
              {
                Module: "Owner portal](/solutions/customer-portal ",
                "What it does":
                  "Statements, distributions, approvals, document vault — the retention layer PM businesses underrate",
              },
              {
                Module: "**Leasing & vacancy**",
                "What it does":
                  "Listing syndication feeds, [showing scheduling](/solutions/booking-system/), applicant pipelines",
              },
              {
                Module: "**HOA variant**",
                "What it does":
                  "Dues, violations workflows, ARC requests, board portals — same money discipline, association-shaped",
              },
              {
                Module: "Reporting](/solutions/analytics-dashboards ",
                "What it does":
                  "Delinquency, vacancy, maintenance aging, per-property P&L — numbers that match the bank because the ledger does",
              },
              {
                Module: "PM AI](/services/ai-application-development ",
                "What it does":
                  "Maintenance-triage assistants, leasing-inquiry agents with [showing booking](/services/ai-agent-development/), lease-document extraction — [fair-housing-reviewed](/industries/real-estate/) always",
              },
            ],
          },
        ],
        cta: "[#scoping] Book a PM Platform Scoping Call\nBring the door count, the fee schedule, and the statement-day pain — leave with the crossover math and a money-core-first phased quote.",
        sourceFile: "wave0-batch8/sol11-property-management.md",
      },
    },
    {
      ...
      meta: {
        ...
        description:
          "Custom recommendation engines development — your rules, your integrations, ownership economics. Honest build-vs-buy scoping.",
      },
      content:
      ...
      structured: {
        ...
        tables: [],
        cta: "Book a Scoping Call\nBring the workflow and the current tool's invoice — leave with the crossover math and a fixed quote.",
        sourceFile: "wave1-generated/solutions/recommendation-engines.md",
      },
    },
    {
      ...
      meta: {
        ...
        description:
          "Custom ride-sharing app development development — your rules, your integrations, ownership economics. Honest build-vs-buy scoping.",
      },
      content:
      ...
      structured: {
        ...
        tables: [],
        cta: "Book a Scoping Call\nBring the workflow and the current tool's invoice — leave with the crossover math and a fixed quote.",
        sourceFile: "wave1-generated/solutions/ride-sharing-app.md",
      },
    },
    {
      ...
      meta: {
        ...
        description:
          "Custom robotic process automation development — your rules, your integrations, ownership economics. Honest build-vs-buy scoping.",
      },
      content:
      ...
      structured: {
        ...
        tables: [],
        cta: "Book a Scoping Call\nBring the workflow and the current tool's invoice — leave with the crossover math and a fixed quote.",
        sourceFile: "wave1-generated/solutions/rpa-development.md",
      },
    },
    {
      ...
      meta: {
        ...
        description:
          "Custom telehealth platform development development — your rules, your integrations, ownership economics. Honest build-vs-buy scoping.",
      },
      content:
      ...
      structured: {
        ...
        tables: [],
        cta: "Book a Scoping Call\nBring the workflow and the current tool's invoice — leave with the crossover math and a fixed quote.",
        sourceFile: "wave1-generated/solutions/telehealth-platform.md",
      },
    },
    {
      ...
      meta: {
        ...
        description:
          "Custom ticketing system development development — your rules, your integrations, ownership economics. Honest build-vs-buy scoping.",
      },
      content:
      ...
      structured: {
        ...
        tables: [],
        cta: "Book a Scoping Call\nBring the workflow and the current tool's invoice — leave with the crossover math and a fixed quote.",
        sourceFile: "wave1-generated/solutions/ticketing-system.md",
      },
    },
    {
      ...
      meta: {
        ...
        description:
          "Custom vendor portal development development — your rules, your integrations, ownership economics. Honest build-vs-buy scoping.",
      },
      content:
      ...
      structured: {
        ...
        tables: [],
        cta: "Book a Scoping Call\nBring the workflow and the current tool's invoice — leave with the crossover math and a fixed quote.",
        sourceFile: "wave1-generated/solutions/vendor-portal.md",
      },
    },
    {
      ...
      meta: {
        ...
        description:
          "Custom voice ai solutions development — your rules, your integrations, ownership economics. Honest build-vs-buy scoping.",
      },
      content:
      ...
      structured: {
        ...
        tables: [],
        cta: "Book a Scoping Call\nBring the workflow and the current tool's invoice — leave with the crossover math and a fixed quote.",
        sourceFile: "wave1-generated/solutions/voice-ai.md",
      },
    },
    {
      ...
      structured: {
        faqs: [
          {
            question: "How disruptive is WMS go-live? We ship every day.",
            answer:
              "Deployment is engineered like a [plant rollout](/industries/manufacturing/): one zone or client first, paper parallel for a wave cycle, cutover between shifts, rollback staged. Your ship schedule is a design constraint we quote against — reference calls can speak to it.",
          },
          {
            question: "Can it handle our customers' EDI routing guides?",
            answer:
              "Yes — 856 ASNs, 945s, label specs, and the retailer-compliance details that generate chargebacks when missed. [EDI without flinching →](/services/api-development/)",
          },
          {
            question: "We're a 3PL. Can it bill our clients properly?",
            answer:
              "Purpose-built for it: every handling event captured at scan becomes a billable line — storage, touches, VAS — per client contract terms. Most 3PLs find billable events they'd been eating; the module typically pays for the build.",
          },
          {
            question: "Do we need wave picking / batch picking / zone picking?",
            answer:
              "Depends entirely on your order profile (lines per order, orders per day, SKU velocity spread) — which is why scoping starts there. We'll recommend the strategy the math supports and build the others as options when profiles shift seasonally.",
          },
          {
          ...
          {
            question: "Can it talk to our ERP/ecommerce stack?",
            answer:
              "That's half the build: orders in, confirmations and inventory out, with daily reconciliation reports so the office and the floor stop debating whose number is right. [Integration services →](/services/api-development/)",
          },
        ],
        tables: [
          {
            headers: ["Module", "What it runs"],
            rows: [
              {
                Module: "**Receiving & putaway**",
                "What it runs":
                  "ASN-based or blind receiving, exception flags, directed putaway by slotting rules — dock-to-stock time measured",
              },
              {
                Module: "**Directed picking**",
                "What it runs":
                  "Single/batch/zone/wave strategies matched to your order profile; scan-verified at pick; pick-path optimization for your actual layout",
              },
              {
                Module: "**Packing & cartonization**",
                "What it runs":
                  "Pack verification, carton suggestions, [rate-shopped shipping labels](/services/api-development/) (carrier APIs), branded packing docs",
              },
              {
                Module: "**Shipping & load**",
                "What it runs":
                  "Staging, BOL/ASN generation, [EDI 856/945 where retail customers demand it](/industries/logistics/) — routing-guide compliance built in",
              },
              {
                Module: "**Locations & slotting**",
                "What it runs":
                  "Bin-level truth, velocity-based slotting suggestions, replenishment triggers to pick faces",
              },
              {
                Module: "**Counting & accuracy**",
                "What it runs":
                  "Cycle counts by ABC, variance workflows, accuracy dashboards by zone/worker",
              },
              {
                Module: "**Returns processing**",
                "What it runs":
                  "Receive, inspect, disposition (restock/refurb/scrap) with reason capture — [the ecommerce necessity](/industries/ecommerce/)",
              },
              {
                Module: "**3PL billing** (for 3PLs)",
                "What it runs":
                  "Storage, handling, and value-added-service capture per client, feeding invoices that end billing disputes",
              },
              {
                Module: "**Labor & performance**",
                "What it runs":
                  "Tasks per hour by function, honestly framed — visibility for coaching, not surveillance theater",
              },
              {
                Module:
                  "Client/ERP visibility](/solutions/customer-portal ",
                "What it runs":
                  "3PL client portals; [ERP/ecommerce sync](/solutions/erp-development/) with reconciliation reports",
              },
            ],
          },
        ],
        cta: "[#walkthrough] Book a Warehouse Walkthrough Call\nBring the floor plan and a week of order data — leave with a picking-strategy recommendation, an architecture sketch, and a phased quote.",
        sourceFile: "wave0-batch7/sol04-warehouse-management.md",
      },
    },
    {
      ...
      structured: {
        faqs: [
          {
            question: "Will people actually use it, or route around it?",
            answer:
              'They route around friction, so we remove it: act-from-email/Slack, mobile approvals in two taps, and intake simpler than the old "email Sarah" path. Adoption is also enforced structurally — when the workflow is the only way work gets credited and tracked, the shadow process dies of loneliness. [Change-management playbook →](/resources/digital-transformation/change-management-software-rollouts/)',
          },
          {
            question: "Can external parties (clients, vendors) participate?",
            answer:
              "Yes — scoped [portal views](/solutions/customer-portal/) let outsiders submit, upload, approve, and track their items without seeing your internals. External participation is one of the strongest custom-over-platform arguments.",
          },
          {
            question: "Where does AI fit without breaking auditability?",
            answer:
              "At intake (extraction, classification, routing) and at drafting stages — always attributed, always gated where consequences warrant, always logged like any other actor. [The examiner-survivable version →](/resources/ai-development/enterprise-ai-governance/) is the only version we ship.",
          },
          {
            question: "How fast is the first process live?",
            answer:
              "Mapped in week 1–2, running on staging by week 4–5, live with real volume by week 6–10 — with the wait-state metrics baselined before cutover so the improvement is a number, not a feeling.",
          },
        ],
            ...
            rows: [
              {
                ...
                "What it does":
                  "Your flows as configurable definitions — stages, owners, conditions, parallel branches — changeable by admins, [not code deploys](/resources/software-engineering/feature-flags/)",
              },
              {
                Module: "**Approval chains**",
                "What it does":
                  "Sequential/parallel/threshold-based approvals with delegation, vacation rules, and dual-control where money demands it — [four-eyes built in](/industries/banking/)",
              },
              {
                Module: "**SLA timers & escalation**",
                "What it does":
                  "Every stage clocked; approaching-breach nudges; breach escalations up the actual org chart",
              },
              {
                Module: "**Task routing & queues**",
                "What it does":
                  "Work assigned by role, load, or round-robin — with team queues that survive individual absence",
              },
              {
                Module:
                  "Document flow](/solutions/document-management-system ",
                "What it does":
                  "Attachments, versioning, e-signature integration, generated documents from templates at the right stage",
              },
              {
                Module: "**Forms & intake**",
                "What it does":
                  'Structured request capture (the front door that replaces "just email Sarah") with conditional fields and validation',
              },
              {
                Module: "**Audit trail**",
                "What it does":
                  "Who did what, when, and under what rule — [immutable, exam-ready](/resources/architecture/designing-for-auditability/) in regulated contexts",
              },
              {
                Module: "Dashboards](/solutions/analytics-dashboards ",
                "What it does":
                  "Cycle time by stage, wait-state heatmaps, aging queues, SLA performance — the metrics that turn process debates into decisions",
              },
              {
                Module: "AI layer](/services/ai-application-development ",
                "What it does":
                  "Document extraction at intake, request classification and routing, drafting at review stages, [triage agents](/solutions/ai-agents/) with approval gates",
              },
            ],
          },
        ],
        cta: "[#mapping] Book a Workflow Mapping Call\nBring the process that makes everyone sigh — leave with its wait-state map, a simplified flow, and a fixed quote for automating it.",
        sourceFile: "wave0-batch7/sol06-workflow-automation.md",
      },
    },
  ],
};
...
export function getSolutionsByUrl(url: string): PageData | undefined {
  ...
  return solutionsData.pages.find(
    (page) =>
      page.url === url ||
      page.url === `/${url}` ||
...
export function getSolutionsByKeyword(keyword: string): PageData[] {
  return solutionsData.pages.filter(
    (page) =>
